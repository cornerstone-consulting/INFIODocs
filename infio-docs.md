...
- [Unsupported functionalities in Infio Tool](#unsupported-functionalities-in-infio-tool)
...
### **Unsupported functionalities in Infio Tool**

In the following table and lists, you can find functionality that isn't currently supported in Infio tool.
