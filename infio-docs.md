...
-----
Note: 
Is this true, would we need to tell them that they will need to wait around 20 minutes foe the password to become available and windoes user profile needs additional 20-30 minutes to be ready. 
...
--------
Note: 
We could put this step before explaining endpoint deployment. 5. Steps for setting up AWS Resources for INFIO EC2 instance
...
---
Note: 
It could be mentioned that the IAM role of the EC2 has all the necessary permissions. 
